        ...
        stubFor(get(urlPathMatching("/catalogue-api/products"))
                ...
                .willReturn(okJson("""
                        [
                            {
                                "id": 1,
                                "title": "Filtered product N1",
                                "details": "Description of the filtered product N1"
                            },
                            {
                                "id": 2,
                                "title": "Filtered product N2",
                                "details": "Description of the filtered product N2"
                            },
                            {
                                "id": 3,
                                "title": "Filtered product N3",
                                "details": "Description of the filtered product N3"
                            }
                        ]""")));
    }
